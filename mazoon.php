							...
							<a href="#" class="text-decoration-none block-link pt-md">
								<span class="thumb-info thumb-info-preview thumb-info-preview-long mb-md">
									<span class="thumb-info-wrapper">
										<span class="thumb-info-image Cuttle" data-original="img/fish/cuttlefish.jpg" data-plugin-lazyload></span>
									</span>
								</span>
					...
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item classic">
						<div class="portfolio-item center">
							<a href="#" class="text-decoration-none block-link pt-md">
								<span class="thumb-info thumb-info-preview thumb-info-preview-long mb-md">
									<span class="thumb-info-wrapper">
										<span class="thumb-info-image Ribbon" data-original="img/fish/ribbon-fish.jpg" data-plugin-lazyload></span>
									</span>
								</span>
					...
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item classic">
						<div class="portfolio-item center">
							<a href="#" class="text-decoration-none block-link pt-md">
								<span class="thumb-info thumb-info-preview thumb-info-preview-long mb-md">
									<span class="thumb-info-wrapper">
										<span class="thumb-info-image Catfish" data-original="img/fish/catfish.png" data-plugin-lazyload></span>
									</span>
								</span>
					...
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item classic">
						<div class="portfolio-item center">
							<a href="#" class="text-decoration-none block-link pt-md">
								<span class="thumb-info thumb-info-preview thumb-info-preview-long mb-md">
									<span class="thumb-info-wrapper">
										<span class="thumb-info-image Tuna" data-original="img/fish/tuna.jpg" data-plugin-lazyload></span>
									</span>
								</span>
					...
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item classic">
						<div class="portfolio-item center">
							<a href="#" class="text-decoration-none block-link pt-md">
								<span class="thumb-info thumb-info-preview thumb-info-preview-long mb-md">
									<span class="thumb-info-wrapper">
										<span class="thumb-info-image Mackerel" data-original="img/fish/MACKEREL.jpg" data-plugin-lazyload></span>
									</span>
								</span>
					...
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item corporate">
						<div class="portfolio-item center">
							<a href="#" class="text-decoration-none block-link pt-md">
								<span class="thumb-info thumb-info-preview thumb-info-preview-long mb-md">
									<span class="thumb-info-wrapper">
										<span class="thumb-info-image Sardine" data-original="img/fish/sardained.jpg" data-plugin-lazyload></span>
									</span>
								</span>
...
<!-- 					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item corporate">
		...
		<script type="text/javascript">
			$('.Cuttlefish').click(function(){
				window.location.href='cuttlefish.php';
			})
			$('.Ribbon').click(function(){
				window.location.href='ribbon-fish.php';
			})
			$('.Catfish').click(function(){
				window.location.href='catfish.php';
			})
			$('.Tuna').click(function(){
				window.location.href='tuna.php';
			})
			$('.Mackerel').click(function(){
				window.location.href='mackerel.php';
			})
			$('.Sardine').click(function(){
				window.location.href='sardine.php';
			})
		</script>
