					 ...
					 <div class="row">
						<div class="col-md-6">
							<!--Slider Will goes here-->
								<div id="container">
						            <ul class="slide">
						                <li class="first" id="slide-1"><img src="fish/cuttlefish/1.webp" alt="" /></li>
						...
						<div class="col-md-6">
							...
							<p>
								<h5>Cuttlefish, related to the octopus and squid and characterized by a thick internal calcified shell called the cuttlebone.</h5>
							</p>
							</ul>
							...
							<p>This food is very low in Saturated Fat. It is also a good source of Vitamin C and B12, Calcium, Potassium and Zinc, Protein, Riboflavin, Iron, Phosphorus, Copper and Selenium.</p>
