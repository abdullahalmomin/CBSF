					 ...
					 <div class="row">
						<div class="col-md-6">
							<!--Slider Will goes here-->
								<div id="container">
						            <ul class="slide">
						                <li class="first" id="slide-1"><img src="fish/shrimp-vanamei/1.webp" alt="" /></li>
						                <li id="slide-2"><img src="fish/shrimp-vanamei/2.webp" alt="" /></li>
						            </ul>
						            <br>
						            <ul class="thumbs">
						                <li><a href="#slide-1"><img src="fish/shrimp-vanamei/1.webp" /></a></li>
						                <li><a href="#slide-2"><img src="shrimp-vanamei/2.webp" /</a></li>
						            </ul>
						        </div>
						</div> 
						<div class="col-md-6">
							...
							<h5>shrimp (Vanamei)</h5>
							<h5>Family Penaeidae</h5>
							<h5>Scientifc name Litopenaeus vannamei.</h5>
							<h5>English name Whiteleg shrimp (Vannamei)</h5>
