				...
				<div class="container">
					 ...
					 <div class="row">
						...
						<div class="col-md-6">
							...
							<h5>Scientific name: Euthynnus affinis, Auxis rochei rochei, Auxis thazard/thazard</h5>
							<h5>English name: Eastern little tuna, Bullet tuna, Frigate Tuna</h5>

							<hr>

							<h4 class="heading-primary">Fish Details</h4>
							<p>
								<h5>Tuna is  extensively fished commercially, and is popular as a game fish. It is found across cultures and around the world.</h5>
							</p>
							</ul>
							...
							<p>Tuna meat is loaded with Protein, but low in Calories. It is high in Selenium, Niacin, and rich in Omega-3 fatty acids.</p>
